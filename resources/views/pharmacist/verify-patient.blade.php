...
@section('content')
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6 mt-8">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Verify Patient</h2>
        ...
        <form action="{{ route('pharmacist.verify-patient') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Enter the patient's unique identification number</p>
            </div>

            <div class="flex items-center justify-between">
                <a href="{{ url()->previous() }}" class="text-sm font-medium text-gray-600 hover:text-gray-900 flex items-center">
