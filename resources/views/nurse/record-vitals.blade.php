...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="px-6 py-5 border-b border-gray-200 bg-indigo-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-indigo-100">Patient: {{ $patient->name }} (ID: {{ $patient->patient_id }})</p>
                    </div>
                </div>
            </div>
            <div class="px-6 py-4 bg-white">
                <div class="flex flex-wrap gap-4 text-sm text-gray-600">
                    <div class="flex items-center">
                        ...
                        Last recorded: {{ $lastVitals->created_at->diffForHumans() ?? 'Never' }}
                    </div>
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <form action="{{ route('nurse.store-vitals', $patient->patient_id) }}" method="POST" class="px-6 py-4">
                @csrf
        ...
        <div class="mt-8 bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-medium text-gray-900 flex items-center">
                    ...
                    Last Recorded Vitals ({{ $lastVitals->created_at->format('M d, Y h:i A') }})
                </h3>
            </div>
            <div class="px-6 py-4">
